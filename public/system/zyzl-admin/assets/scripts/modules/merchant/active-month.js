    ...
    "init": function () {
      var options = {
        ...
        "columns": [
          ...
          { "name": "mch_name", text: "商户名称", "filter": true, filterindex: 4 },
          { "name": "begin_date", text: "开始时间", type: "date", filter: 'date', filterindex: 5, display: false },
          { "name": "end_date", text: "结束时间", type: "date", filter: 'date', filterindex: 6, display: false },
