  ...
  app.plugins.activity = {
    ...
    "init": function () {
      var options = {
        ...
        "texts": { "insert": "新增活动信息", "update": "活动信息编辑" },
        "headers": { "edit": { "text": "活动信息" }, "table": { "text": "活动信息列表" } },
        "actions": { "insert": true, "update": true, "delete": true },
        "columns": [
          { "name": "_index", "text": "序号" },
          { "name": "id", "primary": true },
          { "name": "name", "text": "活动名称", "base64": true, "edit": true, "filter": true, "overflow": 10 },
          { "name": "type", "text": "活动类型", "dict": "activitytype", "edit": true, "filter": true },
          { "name": "describe", "text": "活动描述", "type": "mulittext", "rows": 5, "base64": true, "edit": true, "overflow": 10 },
          { "name": "price", "text": "单价", "edit": true, "filter": true },
          { "name": "begintime", "text": "起始时间", "type": "datetime", "edit": true, "filter": "daterange" },
          { "name": "endtime", "text": "结束时间", "type": "datetime", "edit": true, "filter": "daterange" },
          { "name": "person", "text": "成人限额", "edit": true },
          { "name": "children", "text": "孩子限额", "edit": true },
