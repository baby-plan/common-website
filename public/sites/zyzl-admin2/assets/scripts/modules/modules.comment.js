...
(function (app) {
   ...
   */
  var AddComment = function(text, targetid, targettype, fn)  {
    var options = {
      "text": text,
      "targetid": targetid,
   ...
   */
  var RemoveComment =function (commentid, fn)  {
   ...
   */
  var GetComment =function (targetid, targettype, targetctrl)  {
   ...
   * @param {string} targettype 待评论的目标类型
   */
  var OpenCommentView = function(targetid, targettype)  {
    let $containerId = "_comment_" + targettype + "_" + targetid + "_";
