 ...
 * ======================================================================== */
define(['jquery', 'cfgs', 'API', 'generator', 'ajax', 'base64', 'layout'],
  function ($, cfgs, API, generator, ajax, base64, layout) {
    "use strict";
    /**初始化角色列表方法
     * @param  {} filter
     * @param  {} column
    ...
    var initRole = function (filter, column, value) {
      ...
      layout.form.initCache({
        ...
        "textfn": function (index, item) { return base64.decode(item.name); },
