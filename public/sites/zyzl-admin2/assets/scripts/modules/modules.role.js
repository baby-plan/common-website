/* ========================================================================
 * modules.role.js v1.0
 * 101.角色管理插件
 * ========================================================================
 * Copyright 2016-2026 WangXin nvlbs,Inc.
 * ======================================================================== */
define(['jquery', 'cfgs', 'API', 'generator', 'ajax', 'base64', 'dialog'],
  function ($, cfgs, API, generator, ajax, base64, dialog) {
    "use strict";
    var api = API.role;
    ...
    var initEditor = function (data) {
      ...
      if (data) {
        ...
        $("#rolename").val(base64.decode(data.name));
      ...
      $(".btn_save").on("click", function (e) {
        ...
        if (args.rolename == "") {
          dialog.alertText("角色名称不能为空!");
          return;
        }
        args.name = base64.encode(args.name);
