  ...
  cfgs.modules = {
    ...
    "MCH_MANAGEMENT": {
      ...
      "actions": [
        ...
        { "id": "MCH_MANAGEMENT_APPROVAL", "name": "通过审核", "action": "approval" },
        { "id": "MCH_MANAGEMENT_REJECT", "name": "驳回审核", "action": "reject" },
    ...
    "ORDER_SEARCH": {
      ...
      "actions": [
        ...
        { "id": "ORDER_SEARCH_APPROVAL", "name": "通过审核", "action": "approval" },
        { "id": "ORDER_SEARCH_REJECT", "name": "驳回审核", "action": "reject" },
      ]
    },
    ...
    "MCH_NOTICE": {
      ...
      "actions": [
        ...
        { "id": "MCH_NOTICE_APPROVAL", "name": "通过审核", "action": "approval" },
        { "id": "MCH_NOTICE_REJECT", "name": "驳回审核", "action": "reject" },
