  ...
  var execute = function () {
    ...
    db.query(command.sql, command.params, function (err, result) {
      if (err) {
        ...
        dblogger.write("新增成功", req.connection.remoteAddress, req.session.user, entity.table);
...
// exports.executeSimpleSelect = _execute_simple_select;
// exports.executeDelete = _execute_delete;
// exports.executeUpdate = _execute_update;
// exports.executeInsert = _execute_insert;
