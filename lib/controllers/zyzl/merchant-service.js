module.exports = {
  ...
  // 0	mch_id	varchar	32	0	0					0
  // 0	name	varchar	100	0	1					0
  // 0	type	smallint	2	0	1	0		0	1	0
  // 0	status	smallint	1	0	1	0		0	1	0
  // 0	service_type	varchar	32	0	1					0
  // 0	car_type	varchar	32	0	1					0
  // 0	computing_mode	smallint	1	0	1	0	计费方式	0	0	0
  // 0	price	int	10	0	1	0	单价	0	1	0
  // 0	contract_discount	int	10	0	1	0	签约折扣	0	1	0
  // 0	sell_discount	int	10	0	1	0	销售折扣	0	1	0
  // 0	discount_price	int	11	0	1	0	折后价	0	0	0
  // 0	publish_status	smallint	1	0	1	0		0	1	0
  // 0	audit_status	smallint	1	0	1	0		0	1	0
  // 0	is_can_free_ticket	smallint	1	0	1	0	是否允许使用免费券	0	1	0
  // 0	is_hidden	smallint	1	0	1	0	是否隐藏	0	1	0
  // 0	creator	varchar	32	0	1					0
  // 0	create_time	bigint	13	0	0		记录创建时间，utc格式	0	0	0
  // 0	last_modify_time	bigint	13	0	1	0	记录最后修改时间，utc格式	0	0	0
  "entity": {
    "table": "ym_merchant_service",
    "columns": [
      { "name": "id", "caption": "服务项目编号", "primary": true, "uuid": true },
      { "name": "mch_id", "caption": "商户编号", "filter": true, "requid": true },
      { "name": "nanme", "caption": "服务项目名称", "base64": true, "filter": true },
      ...
      { "name": "creator", "caption": "创建者", "base64": true, "insertdefault": (req) => { return req.session.user; } },
