...
module.exports = {
  ...
  "entity": {
    ...
    "columns": [
      ...
      { "name": "ModuleName", "caption": "菜单名称", "base64": true, "filter": "like", "requid": true },
      { "name": "ModuleParent", "caption": "所属父级", "filter": true },
      { "name": "ModulePage", "caption": "页面地址", "base64": true, },
      { "name": "ModulePackage", "caption": "页面组件包", "base64": true, },
      { "name": "ModuleInitMethod", "caption": "页面初始化方法", "base64": true, },
      { "name": "ModuleArgs", "caption": "页面参数", "base64": true, },
      { "name": "ModuleMethods", "caption": "页面功能清单", "base64": true, },
      { "name": "ModuleDestory", "caption": "页面销毁函数", "base64": true, },
      { "name": "ModuleIcon", "caption": "页面图标", "base64": true, },
      { "name": "ModuleDesc", "caption": "页面描述", "base64": true, },
      { "name": "CreateUser", "caption": "创建者", "base64": true, "insertdefault": (req, res) => { return req.session.user; } },
      { "name": "CreateTime", "caption": "创建时间", "insertdefault": (req, res) => { return new Date().getTime() / 1000; } },
      { "name": "LastModifyUser", "caption": "最后修改者", "base64": true, "default": (req, res) => { return req.session.user; } },
